...
resource "google_container_cluster" "autopilot-cluster" {
  ...
  network           = "projects/${var.shared_project_id}/global/networks/${var.network}"
  subnetwork        = "projects/${var.shared_project_id}/regions/${var.cluster_region}/subnetworks/${var.subnet_name}"
